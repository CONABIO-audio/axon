...
from axon.project.templates import get_template
from axon.project import project_git
from axon.project.project_dvc import init as dvc_init
from axon.project.paths import find_in_directory
...
class Project:
    ...
    def _initialize_git_repo(self):
        ...
        self.repo = project_git.create_repository(self.path)
    ...
    def _initialize_dvc_repo(self):
        ...
        project_git.git_add_and_commit(self.repo, [dvc_files], commit_message)
    ...
    def _add_base_files(self):
        ...
        project_git.git_add_and_commit(self.repo, basic_files, commit_message)
    ...
    def _add_base_directory_structure(self):
        ...
        project_git.git_add_and_commit(
            self.repo,
            structure_files,
            commit_message)
    ...
    def run_pip(self, *args, update=False):
